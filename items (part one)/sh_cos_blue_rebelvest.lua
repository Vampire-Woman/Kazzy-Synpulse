...
ITEM.UniqueID = "cos_blue_rebelvest"
ITEM.Name = "Armored Blue Jacket"
ITEM.Desc =  "A blue denim jacket, fortified by salvaged Combine ballistic armor. It provides great protection."
ITEM.Category = "Armor"
