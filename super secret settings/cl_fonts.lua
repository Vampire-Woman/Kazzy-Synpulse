...
surface.CreateFont( "synChatFontCombine", {
	font = "BoxedRoundLight",
	size = 22
})

surface.CreateFont( "synChatFontItalics", {
	font = "DIN Pro Italic",
	size = 21,
	italics = true
})

surface.CreateFont( "fagfont", {
	font = "DIN Pro",
	size = 18,
	weight = 550
})

surface.CreateFont( "synChatFont", {
	font = "DIN Pro",
	size = 21
})

surface.CreateFont( "inFont", {
	font = "DIN Pro Italic",
	size = 18,
	weight = 700,
	shadow = true,
