if SERVER then
	...
	function meta:SendTrackedCombineWaypoint(message, pos, duration, icon, colour, unit, sender, citizen, overwatch, trackedEnt)
				  impulse.AddCombineWaypoint(message, pos, duration, icon, colour, 1, false, false, false, true, true, trackedEnt)
		print(trackedEnt:GetName())
		print(trackedEnt:GetPos())
	end
end