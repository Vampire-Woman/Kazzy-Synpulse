...
local spLogo = Material("impulse_citadel/suppressed-logo-multi.png")
...
function impulse.render.glowgo(x,y,w,h)
    ...
    draw.SimpleText(impulse.Config.Community, "Impulse-Elements78", x + w / 2, y, col, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
end

function impulse.render.hl2logo(x,y,w,h)
	local from, to = hook.Run("GetFrameworkLogoColour")

	surface.SetMaterial(spLogo)
